...
api = '7897509856:AAGzyktr7yNuVXHVsofX0Hj_mEMVJn_RvRE'
bot = Bot(token=api)
...
async def get_buying_list(message):
    for i in range(1, 5):
        ...
        with open(f'picture_photo/Продукт{i}.jpg', 'rb') as pp:
            await message.answer_photo(pp, reply_markup=inline_menu)
